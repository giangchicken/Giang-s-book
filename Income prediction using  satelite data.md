...
The code for scraping and data processing can be found hear, so this section will present notes and describe this code. [scrape data](https://github.com/chrisyeh96/africa_poverty_clean/blob/main/preprocessing)
